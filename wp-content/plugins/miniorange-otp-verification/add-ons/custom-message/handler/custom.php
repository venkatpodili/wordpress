...
class CustomMessages extends BaseAddOnHandler
{
    ...
    private function checkStatusAndShowMessage($content)
    {
        ...
        $msg = $content ? MoMessages::showMessage(BaseMessage::CUSTOM_MSG_SENT)
                        : MoMessages::showMessage(BaseMessage::CUSTOM_MSG_SENT_FAIL);
    ...
    private function checkStatusAndSendJSON($content)
    {
        ...
        if($content) {
            wp_send_json(MoUtility::_create_json_response(
                MoMessages::showMessage(BaseMessage::CUSTOM_MSG_SENT),
