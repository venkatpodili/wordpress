	...
	class WooCommerceNewCustomerNotification extends SMSNotification
	{
		...
		function __construct()
		{
			...
			$this->smsBody 			=  get_wc_option('woocommerce_registration_generate_password','') === 'yes'
										? MoWcAddOnMessages::showMessage('NEW_CUSTOMER_SMS_WITH_PASS')
										: MoWcAddOnMessages::showMessage('NEW_CUSTOMER_SMS');
		...
		function sendSMS(array $args)
		{
			...
			$smsBody 		= MoUtility::replaceString(array( 'site-name' =>get_bloginfo() , 'username' => $username,
