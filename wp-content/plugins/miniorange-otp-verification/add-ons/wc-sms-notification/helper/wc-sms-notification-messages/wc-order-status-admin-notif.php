<?php
	...
	class WooCommerceAdminOrderstatusNotification extends SMSNotification
	{
		...
		function __construct()
		{
			...
			$this->recipient 		= MoWcAddOnUtiltiy::getAdminPhoneNumber();
			$this->smsBody 			= MoWcAddOnMessages::showMessage('ADMIN_STATUS_SMS');
			$this->defaultSmsBody 	= MoWcAddOnMessages::showMessage('ADMIN_STATUS_SMS');
