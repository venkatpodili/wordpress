...
class Template extends BaseActionHandler
{
	...
	protected $img = "<div style='display:table;text-align:center;'>".
                        "<img src='{{LOADER_CSV}}'>".
                      "</div>";
	...
	public static $paneContent      = "<div style='text-align:".
                                                    "center;width: 100%;".
                                                    "height: 450px;".
                                                    "display: block;".
                                                    "margin-top: 40%;".
	...
	public static $messageDiv       = "<div style='font-style: italic;".
                                                    "font-weight: 600;".
                                                    "color: #23282d;".
	...
	public static $successMessageDiv= "<div style='font-style: italic;".
                                                    "font-weight: 600;".
                                                    "color: #23282d;".
                                                    "font-family:Segoe UI,Helvetica Neue,sans-serif;".
                                                    "color:#138a3d;'>".
