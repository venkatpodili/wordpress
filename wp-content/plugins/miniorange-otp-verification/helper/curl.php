...
class MocURLOTP
{
    ...
    private static function getTimestamp()
    {
        ...
        return self::callAPI($url,null,null,"POST");
    }

    private static function callAPI($url, $json_string, $headers = array("Content-Type: application/json"),$method=null)
    {
        $ch = curl_init($url);
        ...
        curl_setopt($ch, CURLOPT_POST, !is_null($json_string) || $method=="POST" ? true : false);
