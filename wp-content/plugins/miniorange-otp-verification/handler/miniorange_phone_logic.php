...
final class PhoneVerificationLogic extends VerificationLogic
{
	...
	public function _handle_otp_sent($user_login,$user_email,$phone_number,$otp_type,$from_both,$content)
	{
		...
		if(MoUtility::micr() && !MoUtility::mclv())
			update_mo_option('phone_transactions_remaining',get_mo_option('phone_transactions_remaining')-1);
	...
	{
		return get_mo_option("success_phone_message","mo_otp_") ? mo_(get_mo_option('success_phone_message',"mo_otp_"))
	...
	{
		return get_mo_option("error_phone_message","mo_otp_") ? mo_(get_mo_option('error_phone_message',"mo_otp_"))
	...
	{
		return get_mo_option("invalid_phone_message","mo_otp_") ? mo_(get_mo_option('invalid_phone_message',"mo_otp_"))
	...
	{
		return get_mo_option("blocked_phone_message","mo_otp_") ? mo_(get_mo_option('blocked_phone_message',"mo_otp_"))
