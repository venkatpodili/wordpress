...
final class EmailVerificationLogic extends VerificationLogic
{
	...
	{
		return get_mo_option("success_email_message","mo_otp_") ? mo_(get_mo_option('success_email_message',"mo_otp_"))
	...
	{
		return get_mo_option("error_email_message","mo_otp_") ? mo_(get_mo_option('error_email_message',"mo_otp_"))
	...
	{
		return get_mo_option("blocked_email_message","mo_otp_") ? mo_(get_mo_option('blocked_email_message',"mo_otp_"))
	...
	public function _get_otp_invalid_format_message() {
        return get_mo_option("invalid_email_message","mo_otp_") ? mo_(get_mo_option('invalid_email_message',"mo_otp_"))
            : MoMessages::showMessage('ERROR_EMAIL_FORMAT');
    }
}