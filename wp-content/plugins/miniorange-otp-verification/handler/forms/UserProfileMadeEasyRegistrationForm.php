		...
		function handle_post_verification($redirect_to,$user_login,$user_email,$password,$phone_number,$extra_data)
		{
	 	...
	 	function processAndStartOTPVerification($user_name,$user_email,$phone_number)
	 	{
	 		if(strcasecmp($this->_otpType,$this->_typePhoneTag)==0)
				$this->sendChallenge($user_name,$user_email,null,$phone_number,"phone");
			else if(strcasecmp($this->_otpType,$this->_typeBothTag)==0)
				$this->sendChallenge($user_name,$user_email,null,$phone_number,"both");
			else
				$this->sendChallenge($user_name,$user_email,null,$phone_number,"email");
	 	}
