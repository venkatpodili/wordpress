	...
	class NinjaForm extends FormHandler implements IFormHandler
	{
		...
		function miniorange_ninja_form_user($user_email,$user_name,$phone_number)
		{
			...
			if(strcasecmp($this->_otpType,$this->_typePhoneTag)==0)
				$this->sendChallenge($user_name,$user_email,$errors,$phone_number,"phone");
			else if(strcasecmp($this->_otpType,$this->_typeBothTag)==0)
				$this->sendChallenge($user_name,$user_email,$errors,$phone_number,"both");
			else
				$this->sendChallenge($user_name,$user_email,$errors,$phone_number,"email");
		}
