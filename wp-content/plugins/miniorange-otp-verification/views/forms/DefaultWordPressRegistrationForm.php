...
echo'	<div class="mo_otp_form"><input type="checkbox" '.$disabled.' id="wp_default" class="app_enable" data-toggle="wp_default_options" 
...
echo'
                ...
                mo_draw_tooltip(MoMessages::showMessage('AUTO_ACTIVATE_HEAD'),
                                MoMessages::showMessage('AUTO_ACTIVATE_BODY'));
