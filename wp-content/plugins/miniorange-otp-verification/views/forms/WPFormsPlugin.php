...
echo        '<div class="mo_registration_help_desc" '.$is_wpform_hidden.' id="wpform_options">
                ...
                <div '.($wpform_enabled_type != $wpform_email_type ? "hidden" :"").' class="mo_registration_help_desc" id="wpform_email_option"">
                    <ol>
                        ...
                        <li>'. mo_( "Add a Verification Field to your form where users will enter the OTP sent to their Email Address. Note the Field Label of the Verification field." ).'</li>
                        ...
                        $form_results = get_multiple_form_select($wpform_list_of_forms_otp_enabled,TRUE,TRUE,$disabled,1,'wpform','Label');
...
echo '              </ol>
                ...
                <div '.($wpform_enabled_type != $wpform_phone_type ? "hidden" :"").' class="mo_registration_help_desc" 
                    ...
                    <ol>
                        ...
                        <li>'. mo_( "Add a Verification Field to your form where users will enter the OTP sent to their Phone. Note the Field Label of the Verification field." ).'</li>
                        <li>'. mo_( "Enter your Form ID, Phone Field Label and Verification Field Label below" ).':<br>
                            <br/>'. mo_( "Add Form " ).': <input type="button"  value="+" '. $disabled .' onclick="add_wpform(\'phone\',2);
                                ...
                                $form_results = get_multiple_form_select($wpform_list_of_forms_otp_enabled,TRUE,TRUE,$disabled,2,'wpform','Label');
...
echo
        ...
        multiple_from_select_script_generator(TRUE,TRUE,'wpform','Label',[$counter1,$counter2,0]);
