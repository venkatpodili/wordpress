					...
					<div '.($um_enabled_type != $um_type_phone ? "hidden" : "").' 
						...
						<ol>
							...
							<li>'. mo_( "Enter the phone User Meta Key" );
                                    ...
                                    mo_draw_tooltip(
                                        MoMessages::showMessage('META_KEY_HEADER'),
                                        MoMessages::showMessage('META_KEY_BODY')
                                    );

echo'					            : <input class="mo_registration_table_textbox"
                                             id="mo_customer_validation_um_phone_field_key"
                                             name="mo_customer_validation_um_phone_field_key"
                                             type="text"
				...
				<p>
                    ...
                    mo_draw_tooltip(
                        MoMessages::showMessage('INFO_HEADER'),
                        MoMessages::showMessage('ENABLE_BOTH_BODY')
                    );
...
echo'					            : <input class="mo_registration_table_textbox"
                                             id="mo_customer_validation_um_both_phone_field_key"
                                             name="mo_customer_validation_um_phone_field_key"
                                             type="text"
                                             value="'.$um_register_field_key.'">
                                    <div class="mo_otp_note">
