...
echo                            '</td>
							...
							<tr>
								<td colspan="3"><input type="checkbox" '.$disabled.' name="show_dropdown_on_form" value="1"'.$show_dropdown_on_form.' />
								    '.mo_("Show a country code dropdown on the phone field.").'</td>
							</tr>
