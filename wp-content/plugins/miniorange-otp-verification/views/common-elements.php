<?php
	...
	{
		echo '&nbsp;<a  class="dashicons dashicons-feedback" 
		                href="'.$formalink.'" 
		                title="'.$formalink.'" 
		                target="_blank"></a>';
	}
	...
	function extra_post_data($data=null)
	{
	    $ignore_fields  = [
	        "moFields"     => [
	            'option','mo_customer_validation_otp_token','miniorange_otp_token_submit',
		...
		echo '
			<div class="modropdown" id="modropdown">
				<span class="dashicons dashicons-search"></span>
				    <input type="text" class="dropbtn" placeholder="'.mo_( 'Search and select your Form.' ).'" />				
